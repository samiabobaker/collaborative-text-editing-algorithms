...
def transform_TIBOT_operation(O1: TIBOT2Operation, O2: TIBOT2Operation) -> tuple[TIBOT2Operation, TIBOT2Operation]:
    match O1.operation, O2.operation:
        case TIBOT2InsertionOperation(i, x), TIBOT2InsertionOperation(j, y):
            if i < j:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2InsertionOperation(i, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2InsertionOperation(j+1, y))
            else:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2InsertionOperation(i+1, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2InsertionOperation(j, y))
        case TIBOT2InsertionOperation(i, x), TIBOT2DeletionOperation(j, y):
            if i <= j:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2InsertionOperation(i, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2DeletionOperation(j+1, y))
            else:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2InsertionOperation(i-1, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2DeletionOperation(j, y))
        case TIBOT2DeletionOperation(i, x), TIBOT2InsertionOperation(j, y):
            if i < j:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2DeletionOperation(i, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2InsertionOperation(j-1, y))
            else:
                transformed_O1 = TIBOT2Operation(O1.time_interval, O1.client_id, O1.sequence_number, TIBOT2DeletionOperation(i+1, x))
                transformed_O2 = TIBOT2Operation(O2.time_interval, O2.client_id, O2.sequence_number, TIBOT2InsertionOperation(j, y))
