...
class JupiterClient(ClientDevice):
    ...
    def __perform_local_operation(
        self, operation: JupiterOperation, causing_operation: ClientInsertOperation | ClientDeleteOperation
    ) -> None:
    ...
    def receive_message(self) -> list[ClientInsertOperation | ClientDeleteOperation]:
        ...
        for index, message in enumerate(self.outgoing):
            transformed_outgoing_operation, transformed_operation = JupiterTransform.transform_jupiter_operation(
                message.operation, transformed_operation
            )
            self.outgoing[index] = JupiterMessage(
