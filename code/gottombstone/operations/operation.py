...
class GOTTombstoneOperation:
    ...
    @abc.abstractmethod
    def copy(self) -> GOTTombstoneOperation:
        pass

    @abc.abstractmethod
    def copy_without_relative_addressing(self) -> GOTTombstoneOperation:
        pass

    @abc.abstractmethod
    def remove_all_metadata(self) -> GOTTombstoneOperation:
        pass
    ...
    def is_totally_ordered(self, other: GOTTombstoneOperation) -> bool:
        """
    ...
    def is_causally_ordered(self, other: GOTTombstoneOperation) -> bool:
        """
    ...
    def is_independent(self, other: GOTTombstoneOperation) -> bool:
        """
