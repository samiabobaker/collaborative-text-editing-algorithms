...
class GOTTombstoneClient(ClientDevice):
    ...
    def perform_local_insert(self, operation: ClientInsertOperation) -> GOTInsertOperation:
        ...
        """
        insert_operation = self._generate_insert(
            sequence=[operation.character], idx=self.view_to_model(operation.position)
        )
    ...
    def _undo_non_totally_ordered_operations(
        self, incoming_operation: GOTTombstoneOperation
    ) -> list[GOTTombstoneOperation]:
        """
    ...
    def _redo_undone_operations(
        self, undone_operations: list[GOTTombstoneOperation], newly_performed: GOTTombstoneOperation
    ) -> None:
        """
